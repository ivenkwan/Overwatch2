/*
 * Local pilot variant of wallet-roundtrip.ts (TASK-057): constants point at
 * the http pilot edge instead of the conformance https://localhost:8081
 * target. Logic identical to the committed harness (OpenWallet Foundation
 * @openid4vc + jose).
 */
...
const ISSUER = 'http://127.0.0.1:8090/hkt'
const EDGE = 'http://127.0.0.1:8090'
