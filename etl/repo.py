...
from credential_status import t1_credential_status_job, t1_credential_status_schedule
...
defs = Definitions(
    assets=all_assets,
    jobs=[daily_update_job, t1_detection_job, t1_credential_status_job],
    schedules=[daily_update_schedule, t1_detection_schedule, t1_credential_status_schedule],
)
